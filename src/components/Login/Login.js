...
const Login = (props) => {
  ...
  // Destructure the states to just remove the isValid value and save it under a different name to be used by useEffect
  ...
  useEffect(() => {
    ...
    // Cleanup function
    // This return value is processed first and will clear the previous timeout so the setFormIsValid function 
